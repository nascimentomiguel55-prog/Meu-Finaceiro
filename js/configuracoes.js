...
function aplicarTemaSalvo() {
    ...
    const tema = localStorage.getItem("temaApp") || "dark";

    document.documentElement.setAttribute("data-theme", tema);

    const input = document.getElementById("temaSwitchInput");

    if (input) input.checked = tema === "light";

}

function alternarTema() {

    const atual = localStorage.getItem("temaApp") || "dark";
